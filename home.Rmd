---
title: "Home"
subtitle: "Research. Positions. Opinions."
output: 
  html_document:
    toc: true
    toc_depth: 3
...
[![](https://media.springernature.com/full/nature-cms/uploads/product/sdata/header-87021870c315c48063927b82055c12bc.svg){ width=20% align="left" title="Fundamental social motives across 42 cultures in two waves"}](https://doi.org/10.1038/s41598-022-25228-9)
...
[![](https://www.mdpi.com/img/design/mdpi-pub-logo-blue-small4.png?fff78193ca41c286){ width=10% align="left" title="Paper"}](https://doi.org/10.3390/ijerph18189540)
...
[Chinese Belt & Road](https://en.wikipedia.org/wiki/Belt_and_Road_Initiative) workers are living in own camps and move along the designed path of the to-be-built road. As project progresses, so do sojourners move further away from cities and villages and so they have lesser chances of contact. 

We studied what stereotypes did sojourners have about the local population. 

Using the [stereotype accommodation hypothesis](https://t.co/FYkspOf5KR?amp=1), we expected that there is stereotype formation as a result of information sharing _within_ the sojourner group. 
...
![Figure 1. Mediation model depicting the relation between studied variables.](img/fig1_stformation.png){title="Mediation model"}
...
[![](https://onlinelibrary.wiley.com/pb-assets/journal-banners/1464066x-1501384689843.jpg){ width=30% align="left" title="Paper"}](https://doi.org/10.1002/ijop.12800)
...
In two cross-sectional and multi-national studies using European Social Survey ([ESS](https://www.europeansocialsurvey.org/)) and world Values Survey ([WVS](https://www.worldvaluessurvey.org/)) data, I examine the stereotype accommodation hypothesis (see [here](https://doi.org/10.1177%2F0022022118777300)) regarding stereotype of older people along dimensions of sociability and competence.
...
[![](http://www.itlasgroup.com/img/logo_letras.png){ width=30% align="left" title="DGPs"}](http://www.itlasgroup.com/about.aspx)
...
[ITLAS Group](http://www.itlasgroup.com/about.aspx) is an international and multidisciplinary team of psychologists, software engineers and designers that works on creating and evaluating interventions to improve health by means of technology. ITLAS stands for Internet Treatments for Latin America and Spain, but has expanded since its foundation, and now has active collaborations and projects in other countries. 
...
One example of interventions created by the team is _duelocovid_, wich can be accessed [here](https://duelocovid.com/) (in Spanish only).
...
[![](https://www.dgps.de/typo3conf/ext/customer_sitepackage/Resources/Public/Images/logo-dgps-horizontal.svg){ width=30% align="left" title="DGPs"}](https://www.dgps.de/)

<br />
<br />
<br />

The German Association for Psychology [DGPs](https://www.dgps.de/) provides a platform for German and Germany-affiliated researchers in all sub-disciplines of Psychology to share knowledge and develop together new projects. The association organizes multiple methodological and topic-related events, and is contributing with expertise to many other decision making processes regarding the discipline in the country. 
